...
import { requestChangePassword, confirmChangePassword } from '../../../services/authService';
...
export default function ChangePassword() {
  ...
  const confirmForm = useForm({
    ...
    validate: {
      ...
      newPassword: (value) => (value.length < 6 ? 'Mật khẩu mới phải có ít nhất 6 ký tự' : null),
